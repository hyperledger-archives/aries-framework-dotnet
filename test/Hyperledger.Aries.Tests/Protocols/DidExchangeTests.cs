...
namespace Hyperledger.Aries.Tests.Protocols
{
    public class DidExchangeTests : IAsyncLifetime
    {
        ...
        {
            var (request, _) = await _didExchangeService.CreateRequestAsync(_holderWallet, TestConstants.StewardDid);
        ...
        public async Task CanProcessRequest()
        {
            ...
            var inviteeConnection = await _didExchangeService.ProcessRequestAsync(_issuerWallet, request);
        ...
        public async Task CanCreateResponse()
        {
            ...
            var responderRecord = await _didExchangeService.ProcessRequestAsync(_issuerWallet, request);

            var (response, record) = await _didExchangeService.CreateResponseAsync(_issuerWallet, responderRecord);
        ...
        {
            var (request, requesterRecord) = await _didExchangeService.CreateRequestAsync(_holderWallet, TestConstants.StewardDid);
            
            var responderRecord = await _didExchangeService.ProcessRequestAsync(_issuerWallet, request);

            var (response, _) = await _didExchangeService.CreateResponseAsync(_issuerWallet, responderRecord);
            
            requesterRecord = await _didExchangeService.ProcessResponseAsync(_holderWallet, response, requesterRecord);
        ...
        public async Task CanCreateComplete()
        {
            ...
            var (completeMessage, completeRecord) = await _didExchangeService.CreateComplete(_holderWallet, requesterRecord);
        ...
        public async Task CanProcessComplete()
        {
            ...
            var (response, responseRecord) = await _didExchangeService.CreateResponseAsync(_issuerWallet, responderRecord);
            
            requesterRecord = await _didExchangeService.ProcessResponseAsync(_holderWallet, response, requesterRecord);

            var (completeMessage, completeRecord) = await _didExchangeService.CreateComplete(_holderWallet, requesterRecord);
            
            responderRecord = await _didExchangeService.ProcessComplete(_issuerWallet, completeMessage, responseRecord);
