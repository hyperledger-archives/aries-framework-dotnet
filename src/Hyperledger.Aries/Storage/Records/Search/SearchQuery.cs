...
namespace Hyperledger.Aries.Storage
{
    ...
    internal class SearchExpression<T> : Dictionary<string, T>, ISearchQuery
    {
        ...
        /// <summary>
        /// Returns a <see cref="string"/> that represents the current <see cref="SearchExpression{T}"/>.
        /// </summary>
        /// <returns>A JSON <see cref="string"/> that represents the current <see cref="SearchExpression{T}"/> as WQL.</returns>
