...
namespace Hyperledger.Aries.Features.PresentProof
{
    ...
    public class DefaultProofService : IProofService
    {
        ...
        /// <inheritdoc />
        public virtual async Task<(RequestPresentationMessage, ProofRecord)> CreateRequestFromProposalAsync(IAgentContext agentContext, ProofRequestParameters requestParams,
